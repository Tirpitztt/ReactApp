...
const UsersReducer = (state = stateLoc,action)=>{
    ...
    switch (action.type){
        case ADD_USER:
            return [
                ...state,
                {id:'6',name:'Kokoko',adress:'Almaty',location:{country:'Kazahstah',city:'Almaty'},friends:[],status:'new user hello',avaurl:'http://sun9-27.userapi.com/ay2BrhWYcj5qU3A6GXz6YZxM2Dg2S4RIuJZqig/THsCnD5MnA8.jpg'}
            ]
